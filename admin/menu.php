...
function createPluginAdminMenu() {
	$menuSlug = 'buchungskalender_menu';
	...
	add_submenu_page($menuSlug, 'Kategorien - ' . $menuTitle, 'Kategorien', 'manage_options', $menuSlug . '_categories', 'adminMenu_categories');
	add_submenu_page($menuSlug, 'Objekte - ' . $menuTitle, 'Objekte', 'manage_options', $menuSlug . '_objects', 'adminMenu_objects');
	add_submenu_page($menuSlug, 'Extras - ' . $menuTitle, 'Extras', 'manage_options', $menuSlug . '_extras', 'adminMenu_extras');
}
